...
namespace BashSoft
{
    ...
    {
        public const string ExampleExceptionMessage =
            "Example message!";
        ...
        public const string UnableToGoHigherInPartitionHierarchy =
            "The directory you are trying to access is out of the root folder.";

        public const string InvalidCommand = " is not recognised as a valid command";
